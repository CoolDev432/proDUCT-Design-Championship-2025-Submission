        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
          <SignedOut>
            <SignInButton mode="modal">
              <button className="bg-indigo-600 p-3 px-6 text-white rounded-3xl cursor-pointer hover:opacity-80 transition-all">
                Sign In
              </button>
            </SignInButton>
            <SignInButton mode="modal">
              <button className="bg-pink-500 p-3 px-6 text-white rounded-3xl cursor-pointer hover:opacity-80 transition-all">
                Get Started
              </button>
            </SignInButton>
          </SignedOut>
          ...
          <SignedIn>
            <Link href="/dashboard">
              <button className="bg-blue-600 p-3 px-6 text-white rounded-3xl cursor-pointer hover:opacity-80 transition-all">
                Dashboard
              </button>
            </Link>
            <SignOutButton>
              <button className="cursor-pointer text-red-700 font-medium hover:underline">
                Sign Out
              </button>
            </SignOutButton>
          </SignedIn>
